...
// const Footer = () => {
//   return (
//     <footer className="bg-gray-800 text-white py-1.5 fixed bottom-0 left-0 w-full">
//       <div className="container mx-auto text-center">
//         <p className="text-sm">Developed by Vishal S. Meharwade</p>
//       </div>
//     </footer>
//   );
// };
...
// const Footer = () => {
//   return (
//     <footer className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white py-4 fixed bottom-0 w-full">
...
//           Developed by Vishal S. Meharwade
//         </div>
//       </div>
//     </footer>
//   );
